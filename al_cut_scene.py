...
class Al_Cut_scene:
    ...
    def __init__(self, x = 97, y = 70, face_dir = 1):
        ...
        self.time = 0.0
    def init(self):
        if Al_Cut_scene.image == None:
            Al_Cut_scene.image = load_image("./Cutscene/Al_cutscene.png")
    ...
    def draw(self):
        ...
        Al_Cut_scene.image.draw(self.x, self.y, 1024, 470)
        update_canvas()
...
class Al_Cut_scene2:
    ...
    def __init__(self, x = 1280 - 97, y = 70, face_dir = -1):
        ...
        self.time = 0.0
    def init(self):
        if Al_Cut_scene2.image == None:
            Al_Cut_scene2.image = load_image("./Cutscene/Al_cutscene.png")
    ...
    def draw(self):
        ...
        game_world.render()
        draw_rectangle(0, 0, 1280, 720, 0, 0, 0, 230, True)
        Al_Cut_scene2.image.composite_draw(0, 'h', self.x, self.y, 1024, 470)
        update_canvas()
